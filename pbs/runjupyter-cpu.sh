...
# Work Dir
mkdir ~/github/jlab/cpu-${timestamp}
cd ~/github/jlab/cpu-${timestamp}
ln -s ~/github github
# Start jupyter
jupyter-lab --no-browser --port=${port} --ip=${node} 2>> ~/Jupyter-cpu-${timestamp}.log

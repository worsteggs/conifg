# Generated by Powerlevel10k configuration wizard on 2022-08-31 at 12:06 CST.
...
# lightest, 12h time, angled separators, round heads, round tails, 2 lines,
# disconnected, right frame, sparse, many icons, concise, instant_prompt=verbose.
